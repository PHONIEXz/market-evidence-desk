...
- [x] On 2026-09-25, verified the dataset Sourcebook import is `complete`: 140 selected, 140 distilled, zero unsupported, zero errors. On 2026-09-26, the bounded query preview returned 134/134 eligible published source and claim records; the public graph returned 101 questions, 112 claims and 22 source records. The 140 count is a last-build observation. Check for changes and rebuild before stating a current indexed total on camera.
...
- [x] The published dataset contains 101 research questions and 22 source records (21 distinct source URLs), as verified by an anonymous published query on 2026-09-25. The Sourcebook indexed count, entry coverage, and issue review were verified separately on September 25.
